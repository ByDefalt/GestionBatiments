...
/**
 * Représente un bâtiment avec des informations générales telles que le nom,
 * l'usage, les étages et les pièces. Cette classe est visitable via le pattern
 * Visiteur.
 */
public class Batiment implements Visitable, Serializable {
	...
	/**
	 * Méthode acceptant un visiteur, permettant l'application d'une logique sur ce
	 * bâtiment et ses composants (étages et pièces).
	 * 
	...
	public String toString() {
		return "Batiment{" + ", nom='" + nom + '\'' + ", usage='" + usage + '\'' + ", etages=" + etages + ", pieces="
				+ pieces + '}';
	}
}
