...
/**
 * Classe de gestion de la sérialisation et désérialisation des objets de type {@link Batiment}.
 */
public class BatimentDAO {
     ...
     * @param fileName      le nom du fichier dans lequel les objets seront sérialisés.
