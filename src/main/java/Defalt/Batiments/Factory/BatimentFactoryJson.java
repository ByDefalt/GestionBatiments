...
/**
 * Classe utilitaire pour gérer la sérialisation et la désérialisation des
 * objets {@link Batiment} en JSON. Permet de convertir une liste de bâtiments
 * en fichier JSON et inversement.
 */
public class BatimentFactoryJson {
	 ...
	 * @param nomFichierSortie Le nom du fichier JSON où les bâtiments seront
	 *                         sauvegardés.
	 * @throws Exception Si une erreur d'entrée/sortie survient lors de l'écriture
	 *                   du fichier.
	 */
	 ...
	 *
	 * @param nomFichierEntree Le nom du fichier JSON contenant les données des
	 *                         bâtiments.
	 * @return Une liste d'objets {@link Batiment} reconstruits depuis le fichier
	 *         JSON.
	 * @throws Exception Si une erreur d'entrée/sortie survient lors de la lecture
	 *                   du fichier.
	 */
