...
/**
 * Interface représentant un visiteur capable de traiter différents types
 * d'éléments d'un bâtiment. Implémente le pattern visiteur pour exécuter des
 * opérations spécifiques sur des objets sans modifier leurs classes.
 */
public interface Visiteur {
	 ...
	 * @return un objet {@link TreeItem} contenant les détails générés à partir du
	 *         bâtiment.
	 */
	 ...
	 * @return un objet {@link TreeItem} contenant les détails générés à partir de
	 *         l'étage.
	 */
