...
/**
 * Classe permettant de vérifier la validité d'un bâtiment en analysant ses attributs,
 * ses étages et ses pièces, et en détectant les éventuels problèmes.
 */
public class VerificateurBatiment {

    /**
     * Vérifie les attributs, les étages et les pièces d'un bâtiment pour détecter les problèmes éventuels.
     *
     * @param bat le bâtiment à vérifier.
     * @return une liste de problèmes détectés sous forme d'énumérations {@link ProblemeBatiment}.
     * Si aucun problème n'est détecté, la liste contiendra l'élément {@link ProblemeBatiment#AUCUN}.
     */
