...
/**
 * Énumération représentant les différents types de problèmes pouvant être associés à un bâtiment.
 * Chaque problème peut avoir des détails optionnels sous forme de listes d'identifiants d'étages ou de pièces concernés.
 */
public enum ProblemeBatiment {
    ...
    /**
     * Méthode pour initialiser dynamiquement les listes d'étages et de pièces concernés par le problème.
     *
     ...
     *
     * @return une liste d'identifiants d'étages, ou null si aucun problème n'est défini pour les étages.
     */
     ...
     *
     * @return une liste d'identifiants de pièces, ou null si aucun problème n'est défini pour les pièces.
     */
