 ...
 * <p>
 * Cette classe gère l'affichage des détails d'un bâtiment dans une
 * {@link TreeView}, permet de renommer le bâtiment, de changer le type des
 * pièces et de naviguer à travers différents affichages basés sur des visiteurs
 * spécifiques (par exemple, pour afficher les types de pièces ou la surface des
 * bureaux).
 * </p>
 */
public class VueBatiment implements Observer {
	...
	/**
	 * Constructeur initialisant la vue avec un modèle {@link Campus} et un nom de
	 * bâtiment.
	 *
	...
	/**
	 * Initialisation de la vue après l'injection des éléments FXML. Met à jour
	 * l'affichage des détails du bâtiment.
	 */
	...
	/**
	 * Change le type de la pièce sélectionnée dans la {@link TreeView}. La pièce
	 * sélectionnée doit être de type "Pièce" ou "Bureau".
	 */
	...
	/**
	 * Affiche les pièces du bâtiment en utilisant le visiteur
	 * {@link VisiteurTypePiece}.
	 */
	...
	/**
	 * Affiche les bureaux et leur surface en utilisant le visiteur
	 * {@link VisiteurBureauSurface}.
	 */
	...
	/**
	 * Affiche une fenêtre d'aide pour l'utilisateur expliquant comment utiliser
	 * l'application.
	 */
