 ...
 * <p>
 * Cette classe gère la liste des bâtiments dans l'interface utilisateur, permet
 * l'ajout, la suppression et l'importation de bâtiments depuis un fichier JSON.
 * Elle met à jour la vue en fonction des changements du modèle {@link Campus}.
 * </p>
 */
public class VueListeBatiments implements Observer {
	...
	/**
	 * Initialisation de la vue après l'injection des éléments FXML. Met à jour la
	 * liste des bâtiments affichée.
	 */
	...
	/**
	 * Met à jour la liste des bâtiments affichée dans la vue. Cette méthode est
	 * appelée lorsque le modèle change.
	 */
	@Override
	public void update() {
	...
	public void ajouterBatiment() {
		...
		if (Integer.parseInt(textFieldNombreBureauxBatiment.getText()) > Integer
				.parseInt(textFieldNombrePieceBatiment.getText())) {
			showError("Erreur", "Nombre de bureaux",
					"Le nombre de bureaux doit être inférieur ou égal au nombre de pièces");
			return;
		}

		// Création du bâtiment
		campus.createBatiment(textFieldNomBatiment.getText(), textFieldUsageBatiment.getText(),
				Integer.parseInt(textFieldSurfacePiecesBatiment.getText()), checkBoxNumerotationBatiment.isSelected(),
	...
	/**
	 * Ouvre une boîte de dialogue pour importer un fichier JSON et charger les
	 * bâtiments depuis ce fichier et affiche les erreurs eventuel.
	 */
	...
	/**
	 * Ouvre une boîte de dialogue pour exporter les bâtiments dans un fichier
	 * .save.
	 */
	...
	/**
	 * Ouvre une boîte de dialogue pour importer un fichier .save et charger les
	 * bâtiments depuis ce fichier et affiche les erreurs eventuel.
	 */
